...
@section('content')
    ...
    <div class="ml-navbar">
        ...
        <div class="h-screen w-full">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex items-start mt-5">
                                ...
                                <div class="ml-2">
                                    ...
                                    <p class="font-JetBrains font-medium text-green-800 mt-1">* Disponible del 23 al 29 Noviembre 2022</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-1">
            ...
            <div id="taxis" data-link="4" class="section section-overflow h-screen">
                <div class="container mx-auto relative h-full">
                    <div class="absolute top-1/2 left-0 right-0 transform -translate-y-1/2 px-10">
                        <h2 class="text-5xl text-green-800 font-semibold">Taxis</h2>
                        <h4 class="mt-4">Se recomienda llamar con mucho tiempo de anticipación (15 minutos de espera aproximadamente)</h4>
                        <div class="grid grid-cols-3 gap-7 mt-8">
                            <div class="col-span-1 border border-amber-500 rounded relative px-4 py-4">
                                ...
                                <img src="/images/taxis/taxi-1.jpg" class="h-36 object-contain rounded-md mx-auto mt-3" alt="Imagen de Taxi">
                            ...
                            <div class="col-span-1 border border-amber-500 rounded relative px-4 py-4">
                                ...
                                <img src="/images/taxis/taxi-2.jpg" class="h-36 object-contain rounded-md mx-auto mt-3" alt="Imagen de Taxi">
                                <div class="flex items-start border-t border-amber-500 pt-5 mt-5">
                                    <div class="flex items-start">
                                        <svg class="text-amber-500 flex-shrink-0 w-4 pt-1" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill="currentColor" d="M3.54 2c.06.89.21 1.76.45 2.59l-1.2 1.2c-.41-1.2-.67-2.47-.76-3.79h1.51Zm9.86 12.02c.85.24 1.72.39 2.6.45v1.49c-1.32-.09-2.59-.35-3.8-.75l1.2-1.19ZM4.5 0H1C.45 0 0 .45 0 1c0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.49c0-.55-.45-1-1-1-1.24 0-2.45-.2-3.57-.57a.84.84 0 0 0-.31-.05c-.26 0-.51.1-.71.29l-2.2 2.2a15.149 15.149 0 0 1-6.59-6.59l2.2-2.2c.28-.28.36-.67.25-1.02A11.36 11.36 0 0 1 5.5 1c0-.55-.45-1-1-1Z"/>
                            ...
                            <div class="col-span-1 border border-amber-500 rounded relative px-4 py-4">
                                ...
                                <img src="/images/taxis/taxi-3.jpg" class="h-36 object-contain rounded-md mx-auto mt-3" alt="Imagen de Taxi">
                                <div class="flex items-start border-t border-amber-500 pt-5 mt-5">
                                    <div class="flex items-start">
                                        <svg class="text-amber-500 flex-shrink-0 w-4 pt-1" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill="currentColor" d="M3.54 2c.06.89.21 1.76.45 2.59l-1.2 1.2c-.41-1.2-.67-2.47-.76-3.79h1.51Zm9.86 12.02c.85.24 1.72.39 2.6.45v1.49c-1.32-.09-2.59-.35-3.8-.75l1.2-1.19ZM4.5 0H1C.45 0 0 .45 0 1c0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.49c0-.55-.45-1-1-1-1.24 0-2.45-.2-3.57-.57a.84.84 0 0 0-.31-.05c-.26 0-.51.1-.71.29l-2.2 2.2a15.149 15.149 0 0 1-6.59-6.59l2.2-2.2c.28-.28.36-.67.25-1.02A11.36 11.36 0 0 1 5.5 1c0-.55-.45-1-1-1Z"/>
            ...
            <div id="restaurants" data-link="5" class="section container mx-auto relative h-screen">
                <div class="container mx-auto relative h-full px-10 pt-5 pb-80">
            ...
            <div id="airport" data-link="6" class="section container mx-auto relative h-screen">
                <div class="container mx-auto relative h-full px-10 pt-5 pb-80">
                    <h2 class="text-5xl text-green-800 font-semibold pt-2">Aeropuerto</h2>
                </div>
            </div>

            <div id="location" data-link="7" class="section container mx-auto relative h-screen">
                <div class="container mx-auto relative h-full px-10 pt-5 pb-80">
            ...
            <div id="confirm" data-link="9" class="section container mx-auto relative h-screen">
                <div class="absolute top-1/2 left-0 right-0 transform -translate-y-1/2">
